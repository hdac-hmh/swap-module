...
// RegisterRoutes registers blogibc-related REST handlers to a router
...
func registerQueryRoutes(clientCtx client.Context, r *mux.Router) {
	...
	r.HandleFunc("/blogibc/timedoutPosts/{id}", getTimedoutPostHandler(clientCtx)).Methods("GET")
	r.HandleFunc("/blogibc/timedoutPosts", listTimedoutPostHandler(clientCtx)).Methods("GET")
...
func registerTxHandlers(clientCtx client.Context, r *mux.Router) {
	...
	r.HandleFunc("/blogibc/timedoutPosts", createTimedoutPostHandler(clientCtx)).Methods("POST")
	r.HandleFunc("/blogibc/timedoutPosts/{id}", updateTimedoutPostHandler(clientCtx)).Methods("POST")
	r.HandleFunc("/blogibc/timedoutPosts/{id}", deleteTimedoutPostHandler(clientCtx)).Methods("POST")
