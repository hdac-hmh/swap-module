...
func NewMsgCreateToken(creator string, Owner string, Denom string, Balance string) *MsgCreateToken {
...
func NewMsgUpdateToken(creator string, id uint64, Owner string, Denom string, Balance string) *MsgUpdateToken {
