...
export class MsgClientImpl {
    ...
    CreateToken(request) {
        ...
        const promise = this.rpc.request("hdachmh.swapmodule.mintservice.Msg", "CreateToken", data);
        return promise.then((data) => MsgCreateTokenResponse.decode(new Reader(data)));
    }
    UpdateToken(request) {
        const data = MsgUpdateToken.encode(request).finish();
        const promise = this.rpc.request("hdachmh.swapmodule.mintservice.Msg", "UpdateToken", data);
        return promise.then((data) => MsgUpdateTokenResponse.decode(new Reader(data)));
    }
    DeleteToken(request) {
        const data = MsgDeleteToken.encode(request).finish();
        const promise = this.rpc.request("hdachmh.swapmodule.mintservice.Msg", "DeleteToken", data);
