...
export class QueryClientImpl {
    ...
    Token(request) {
        ...
        const promise = this.rpc.request("hdachmh.swapmodule.mintservice.Query", "Token", data);
    ...
    TokenAll(request) {
        ...
        const promise = this.rpc.request("hdachmh.swapmodule.mintservice.Query", "TokenAll", data);
