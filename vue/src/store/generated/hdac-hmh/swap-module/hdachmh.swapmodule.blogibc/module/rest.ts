...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryPostAll = (
    ...
    this.request<BlogibcQueryAllPostResponse, RpcStatus>({
      path: `/hdac-hmh/swapmodule/blogibc/post`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
  ...
  queryPost = (id: string, params: RequestParams = {}) =>
    this.request<BlogibcQueryGetPostResponse, RpcStatus>({
  ...
  querySentPostAll = (
    ...
    this.request<BlogibcQueryAllSentPostResponse, RpcStatus>({
