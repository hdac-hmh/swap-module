...
export class QueryClientImpl {
    ...
    TimedoutPost(request) {
        ...
        const promise = this.rpc.request("hdachmh.swapmodule.blogibc.Query", "TimedoutPost", data);
    ...
    TimedoutPostAll(request) {
        ...
        const promise = this.rpc.request("hdachmh.swapmodule.blogibc.Query", "TimedoutPostAll", data);
    ...
    SentPost(request) {
        ...
        const promise = this.rpc.request("hdachmh.swapmodule.blogibc.Query", "SentPost", data);
    ...
    SentPostAll(request) {
        ...
        const promise = this.rpc.request("hdachmh.swapmodule.blogibc.Query", "SentPostAll", data);
    ...
    Post(request) {
        ...
        const promise = this.rpc.request("hdachmh.swapmodule.blogibc.Query", "Post", data);
        return promise.then((data) => QueryGetPostResponse.decode(new Reader(data)));
    }
    PostAll(request) {
        const data = QueryAllPostRequest.encode(request).finish();
        const promise = this.rpc.request("hdachmh.swapmodule.blogibc.Query", "PostAll", data);
