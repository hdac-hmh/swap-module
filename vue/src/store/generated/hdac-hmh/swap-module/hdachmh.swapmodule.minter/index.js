...
import { Params } from "./module/types/minter/mint";
...
export default {
    ...
    actions: {
        ...
        async sendMsgMint({ rootGetters }, { value, fee, memo }) {
            try {
                const msg = await (await initTxClient(rootGetters)).msgMint(value);
                ...
                if (e.toString() == 'wallet is required') {
                    ...
                    throw new SpVuexError('TxClient:MsgMint:Send', 'Could not broadcast Tx.');
                }
            }
        },
        async MsgMint({ rootGetters }, { value }) {
            try {
                ...
                if (e.toString() == 'wallet is required') {
                    ...
                    throw new SpVuexError('TxClient:MsgMint:Create', 'Could not create message.');
                }
            }
        },
    }
