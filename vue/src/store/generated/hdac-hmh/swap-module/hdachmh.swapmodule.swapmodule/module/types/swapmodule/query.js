...
export class QueryClientImpl {
    ...
    Token(request) {
        ...
        const promise = this.rpc.request("hdachmh.swapmodule.swapmodule.Query", "Token", data);
    ...
    TokenAll(request) {
        ...
        const promise = this.rpc.request("hdachmh.swapmodule.swapmodule.Query", "TokenAll", data);
