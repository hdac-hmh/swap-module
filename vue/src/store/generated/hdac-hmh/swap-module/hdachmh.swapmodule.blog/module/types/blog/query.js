...
export class QueryClientImpl {
    ...
    Comment(request) {
        ...
        const promise = this.rpc.request("hdachmh.swapmodule.blog.Query", "Comment", data);
    ...
    CommentAll(request) {
        ...
        const promise = this.rpc.request("hdachmh.swapmodule.blog.Query", "CommentAll", data);
    ...
    Post(request) {
        ...
        const promise = this.rpc.request("hdachmh.swapmodule.blog.Query", "Post", data);
        return promise.then((data) => QueryGetPostResponse.decode(new Reader(data)));
    }
    PostAll(request) {
        const data = QueryAllPostRequest.encode(request).finish();
        const promise = this.rpc.request("hdachmh.swapmodule.blog.Query", "PostAll", data);
