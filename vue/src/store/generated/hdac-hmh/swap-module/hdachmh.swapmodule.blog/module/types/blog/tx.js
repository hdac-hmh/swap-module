...
export class MsgClientImpl {
    ...
    CreateComment(request) {
        ...
        const promise = this.rpc.request("hdachmh.swapmodule.blog.Msg", "CreateComment", data);
    ...
    UpdateComment(request) {
        ...
        const promise = this.rpc.request("hdachmh.swapmodule.blog.Msg", "UpdateComment", data);
